...
\newacronym{osswu}{OSSWU}{Optimized Simplified Shallue-van de Woestijne-Ulas}
...
\newacronym{rcig}{RCIG}{Rust Cryptography Interest Group}
\newacronym{rsa}{RSA}{Rivest-Shamir-Adleman}
\newacronym{rtic}{RTIC}{Real-Time Interrupt-drived Concurrency}
\newacronym{rtt}{RTT}{Real-Time-Transfer}
\newacronym{sae}{SAE}{Simultaneous Authentication of Equals}
\newacronym{sha}{SHA}{Secure Hash Algorithm}
\newacronym{sidh}{SIDH}{Supersingular isogeny Diffie-Hellman}
