...
\begin{figure}[H]
  ...
  \caption{An illustration of the difference between \glspl{pake} and tranditional password-based authentication}
...
Below are protocol diagrams illustrating what changes with each configuration change.
