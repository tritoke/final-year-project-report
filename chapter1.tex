...
As \gls{aucpace} is the only \gls{pake} in the list where there is a completely inadequate current solution.
\gls{aucpace} also targets a rapidly growing area, the combined risk of this and the insecure nature of hard coding the key means that \gls{aucpace} is uniquely positioned to make a large difference to the security of the \gls{iiot} landscape.
...
\begin{figure}[H]
  \pseudocodeblock[head=AuCPace,codesize=\footnotesize]{
    ...
    \
    s \sample \bin^{k_1} \< \< s \sample \bin^{k_1} \\
    \< \sendmessageright*{s} \< \\
    \< \sendmessageleft*{t} \< \\
    ssid = \text{H}_0(s||t) \< \< ssid = \text{H}_0(s||t) \\[][\hline]
    \
    ...
    \< \< w = \text{PBKDF}_{\sigma}(pw, \text{user, salt}) \\
    ...
    G = \text{Map2Point}(g') \< \< G = \text{Map2Point}(g') \\
    ...
    sk_1 = \text{H}_2(ssid||K) \< \< K = sk_1 = \text{H}_2(ssid||K) \\[][\hline]
    \
    \< \< \pclb[-0.5\baselineskip]
    \pcintertext[center]{Explicit mutual authentication} \\[-1.5\baselineskip][\hline]
    \
    T_a = \text{H}_3(ssid||sk_1) \< \< T_a = \text{H}_3(ssid||sk_1) \\
    T_b = \text{H}_4(ssid||sk_1) \< \< T_b = \text{H}_4(ssid||sk_1) \\
    \< \sendmessageleft*{T_b} \< \\
    \< \sendmessageright*{T_a} \< \\
    \text{verify}\ T_b \< \< \text{verify}\ T_a \\
    sk = \text{H}_5(ssid||sk_1) \< \< sk = \text{H}_5(ssid||sk_1) \\[][\hline]
  }
