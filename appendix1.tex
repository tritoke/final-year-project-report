...
\pythoncode[minted options={firstline=36,lastline=76}]{Client Negotiate}{eke_python/client.py}
\pythoncode[minted options={firstline=50,lastline=81}]{Server Negotiate}{eke_python/server.py}
