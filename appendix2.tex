...
\pythoncode[minted options={firstline=37,lastline=72,gobble=4}]{Client Negotiate}{srp_python/client.py}
\pythoncode[minted options={firstline=57,lastline=115,gobble=4}]{Server Negotiate}{srp_python/server.py}
